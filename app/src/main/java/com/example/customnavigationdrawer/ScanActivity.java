...
//        Query oldBug = ref.child(DeviceID).child("quet").orderByChild("timestamp").endAt(cutoff);
...
//        });
    ...
    private String getDate(long time) {
        ...
        String date = DateFormat.format("dd-MM-yyyy", cal).toString() +  " " + timeFormat.format(cal.getTime());
